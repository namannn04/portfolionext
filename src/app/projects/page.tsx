      ...
      <div className="relative min-h-screen overflow-hidden sm:max-w-[50%] mx-auto sm:border sm:border-teal-500/40 rounded-xl p-6 sm:shadow-[0_0_15px_rgba(20,184,166,0.15)]">
        ...
        <div className="relative z-10">
          ...
          <div className="mb-16 text-center">
            <h1 className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-teal-400 via-cyan-400 to-teal-400 mt-5 mb-4">
              My Projects
            </h1>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8">
              {projects.map((project) => (
                <div
                  key={project.id}
                  className="group h-[400px] bg-zinc-900/40 backdrop-blur-sm rounded-xl overflow-hidden border border-zinc-800 hover:border-teal-500/50 transition-all duration-500 flex flex-col relative hover:shadow-[0_0_20px_rgba(20,184,166,0.3)] hover:-translate-y-1"
                >
                  {/* Project number */}

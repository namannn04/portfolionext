...
export default function SkillsSection() {
  ...
  return (
    <section id="skills" className="py-16 px-4 md:px-8 text-t-text relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="relative">
          <Card className="bg-t-surface border border-t-border p-8 rounded-xl shadow-2xl backdrop-blur-sm">
            ...
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-5">
              {skills[activeCategory].map((skill) => (
                <div key={skill} className="group relative perspective-500">
                  ...
                  <Badge className="w-full py-3 px-4 text-center bg-t-surface-hover hover:bg-t-surface-hover text-t-text border border-t-border relative z-10 group-hover:translate-y-0.5 group-hover:-translate-x-0.5 transition-transform duration-300">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-t-surface p-6 rounded-xl border-l-4 border-teal-500 shadow-lg backdrop-blur-sm">
          ...
          <div className="bg-t-surface p-6 rounded-xl border-l-4 border-cyan-500 shadow-lg backdrop-blur-sm">
            <div className="flex items-center gap-3 mb-3">
        ...
        <div className="mt-16 flex justify-center">
          <div className="inline-block relative group">
            ...
            <Link href="/resume">
              <button className="relative px-7 py-3 bg-t-surface rounded-lg leading-none flex items-center divide-x divide-t-border cursor-pointer">
                <span className="flex items-center space-x-2 pr-6">
                  <Wrench className="h-5 w-5 text-teal-400" />
                  <span className="text-t-text font-medium">
                    View Full Resume
                  </span>
                </span>
                <span className="pl-6 text-cyan-400 group-hover:text-t-text transition duration-300">
                  See more &rarr;
                </span>
              </button>
            </Link>

...
export default function Page() {
  ...
  const groupProjects: GroupProject[] = [
    ...
    { id: 6, title: "GDGoc Website", description: "As the Head of the Development Department and Project Lead, I spearheaded the website creation for the Google Developers Group on Campus - MSIT (GDGoC - MSIT).", tags: ["React", "Tailwind CSS"], image: "/groupProjects/gdgmsit.jpg", demoUrl: "https://gdgmsit.in/", githubUrl: "", showViewProject: true, contribution: "I personally developed the engaging hero section and the informative events section of the website." },
    ...
    { id: 4, title: "Code-ए-Manipal (Hack Organizer)", description: "Code-ए-Manipal was an offline hackathon organized by the Geek Room community in Jaipur.", tags: ["React", "TypeScript", "Tailwind CSS"], image: "/groupProjects/codemanipal.jpg", demoUrl: "https://codemanipal.geekroom.in/", githubUrl: "", showViewProject: true, contribution: "As an organizer, I completely reframed their website from a template, handling all the work myself." },
    { id: 3, title: "Pears Global Hackathon (Hack Organizer)", description: "The Pears Global Hackathon was a global-level online event organized by the Geek Room community in collaboration with Pears.", tags: ["React", "TypeScript", "Tailwind CSS"], image: "/groupProjects/pears.jpg", demoUrl: "https://pearshack.geekroom.in/", githubUrl: "", showViewProject: true, contribution: "I worked as moderator and on the website, creating sections and fixing bugs." },
    { id: 2, title: "Code Kshetra 2.0 (Hack Organizer)", description: "Code Kshetra 2.0 was a significant national-level offline hackathon with MLH as a partner.", tags: ["React", "TypeScript", "Tailwind CSS"], image: "/groupProjects/ck2.jpg", demoUrl: "https://codekshetra2.geekroom.in/", githubUrl: "", showViewProject: true, contribution: "I served as a moderator and created several sections of the website. Notably, I resolved almost all the bugs." },
    { id: 1, title: "Code Cubicle 3.0 (Hack Organizer)", description: "Code Cubicle 3.0 was a hybrid hackathon organized by the Geek Room community. Offline at Microsoft Office.", tags: ["Next.js", "TypeScript", "Tailwind CSS"], image: "/groupProjects/cc3.jpg", demoUrl: "https://codecubicle3.geekroom.in/", githubUrl: "", showViewProject: true, contribution: "I developed almost the entire website for this hackathon." },
  ];

  const projects: Project[] = [
    { id: 11, title: "bulkMailer", description: "A bulk email sender app with custom styling that allows users to send emails to multiple recipients.", tags: ["Next.js", "Node.js", "Express.js", "Gmail SMTP", "Tailwind CSS"], video: "/projects/bulkmailer.mkv", demoUrl: "", githubUrl: "https://github.com", showViewProject: false },
    ...
    { id: 8, title: "Portfolio v2", description: "My second portfolio website with improved tech stack.", tags: ["React", "Three.js", "Tailwind CSS"], video: "/projects/portfolioReact.mkv", demoUrl: "https://namanportfoliov2.vercel.app/", githubUrl: "", showViewProject: true },
    ...
    { id: 6, title: "Simon Game", description: "A fun and interactive memory game.", tags: ["HTML", "CSS", "JS"], video: "/projects/simon.mkv", demoUrl: "", githubUrl: "https://github.com/namannn04/simon-game", showViewProject: true },
    { id: 5, title: "Portfolio v1", description: "My first portfolio website.", tags: ["HTML", "CSS", "JS"], video: "/projects/tempport.mkv", demoUrl: "", githubUrl: "https://github.com/namannn04/Portfolio-temp", showViewProject: true },
    { id: 4, title: "Spotify Clone", description: "A Spotify clone replicating the landing page.", tags: ["HTML", "CSS"], video: "/projects/spotify.mkv", demoUrl: "", githubUrl: "https://github.com/namannn04/spotify-clone", showViewProject: true },
    { id: 3, title: "Instagram Clone", description: "A clone of Instagram's landing page.", tags: ["HTML", "CSS", "JS"], image: "/projects/insta.jpg", demoUrl: "", githubUrl: "https://github.com/namannn04/instagram-clone", showViewProject: true },
    { id: 2, title: "Calculator", description: "A simple calculator application.", tags: ["HTML", "CSS"], video: "/projects/calculator.mkv", demoUrl: "", githubUrl: "https://github.com/namannn04/calculator", showViewProject: true },
    { id: 1, title: "Samsung Landing Page (custom)", description: "A custom landing page for Samsung.", tags: ["HTML", "CSS", "JavaScript"], video: "/projects/samsung.mkv", demoUrl: "", githubUrl: "https://github.com/namannn04/samsung-landingPage", showViewProject: true },
  ];
